...
namespace Unity.XR.PicoVR
{
    ...
    /// These usages are all PicoVR specific.
    /// </summary>
    public static class PicoVRUsages
    {
        /// <summary>
        ...
        /// <summary>
        /// Represents the capacitive touch thumbrest on PicoVR Rift controllers.
        /// </summary>
        public static InputFeatureUsage<bool> thumbrest = new InputFeatureUsage<bool>("Thumbrest");
        /// <summary>
        /// Represents the capacitive touch sensor state on the trigger of the PicoVR Rift Controller.
        /// </summary>
        public static InputFeatureUsage<bool> indexTouch = new InputFeatureUsage<bool>("IndexTouch");
        /// <summary>
        /// Represents the capacitive touch sensor state on the grip of the PicoVR Rift Controller.
        /// </summary>
